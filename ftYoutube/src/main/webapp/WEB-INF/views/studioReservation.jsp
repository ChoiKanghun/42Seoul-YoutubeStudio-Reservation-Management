...
<body>
  <form action="reservation" method="POST" style="margin : 0 auto;width:50%;text-align:center">
    <fieldset>
...
yyyy<br>
      ...
      <br>
      비밀번호 : <input class="user_pw_info" type="password" name="userPw" onchange="deleteBtn()">
    <br>
      비밀번호 확인 : <input class="user_pw_check" type="password" onchange="deleteBtn()">
...
<body>
  <form onsubmit = "convert_to_hash()" class="" action="post_reservation" method="POST" style="margin : 0 auto;width:50%;text-align:center">
    <fieldset>
    	<input class="radio_studio1" type = "radio" name="number" value = "1" checked/>Studio1
    	<input class="radio_studio2" type = "radio" name="number" value = "2"/>Studio2
      <legend>비회원 로그인</legend>
