...
<body>
  <form class="" action="/ftYoutube/post/studio" method="post" style="margin : 0 auto;width:50%;text-align:center">
    <fieldset>
    	<input type = "radio" name="number" value = "1" checked/>Studio1
    	<input type = "radio" name="number" value = "2"/>Studio2
