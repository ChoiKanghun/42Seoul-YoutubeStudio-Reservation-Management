...
임시서버라 느리고 제가 노트북을 켰을 때만 접속이 가능합니다.
https://1539833c7420.jp.ngrok.io/ftYoutube
현재 API를 받아오는 과정에서 CORS Policy 때문에 오류가 발생합니다.
따라서 로그인을 하실 수 없을텐데, 접속 url 뒤에 `?login=본인인트라아이디` 를 붙 예약할 수 있습니다.
